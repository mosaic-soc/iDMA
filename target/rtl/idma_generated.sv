...
module idma_transport_layer_rw_axi #(
    ...
    idma_otf_compute #(
        .StrbWidth           ( StrbWidth ),
        .ComputeEnable       ( idma_pkg::compute_enable_t'{transpose: 1'b1} ),
...
package idma_reg32_4d_reg_pkg;
    ...
    localparam IDMA_REG32_4D_REG_TOP_SIZE = 'h104;
    ...
    typedef struct packed {
        ...
        logic [9:0] busy;
    } idma_reg_NumDims_4_Log2NumDims_2__status__external__fields__in_t;

    typedef struct {
        logic rd_ack;
        idma_reg_NumDims_4_Log2NumDims_2__status__external__fields__in_t rd_data;
    } idma_reg_NumDims_4_Log2NumDims_2__status__external__in_t;

    typedef struct packed {
        logic [31:0] next_id;
    } idma_reg_NumDims_4_Log2NumDims_2__next_id__external__fields__in_t;

    typedef struct {
        logic rd_ack;
        idma_reg_NumDims_4_Log2NumDims_2__next_id__external__fields__in_t rd_data;
    } idma_reg_NumDims_4_Log2NumDims_2__next_id__external__in_t;

    typedef struct packed {
        logic [31:0] done_id;
    } idma_reg_NumDims_4_Log2NumDims_2__done_id__external__fields__in_t;

    typedef struct {
        logic rd_ack;
        idma_reg_NumDims_4_Log2NumDims_2__done_id__external__fields__in_t rd_data;
    } idma_reg_NumDims_4_Log2NumDims_2__done_id__external__in_t;

    typedef struct {
        idma_reg_NumDims_4_Log2NumDims_2__status__external__in_t status[16];
        idma_reg_NumDims_4_Log2NumDims_2__next_id__external__in_t next_id[16];
        idma_reg_NumDims_4_Log2NumDims_2__done_id__external__in_t done_id[16];
    } idma_reg__in_t;
    ...
    typedef struct {
        logic req;
        logic req_is_wr;
    } idma_reg_NumDims_4_Log2NumDims_2__status__external__out_t;

    typedef struct {
        logic req;
        logic req_is_wr;
    } idma_reg_NumDims_4_Log2NumDims_2__next_id__external__out_t;

    typedef struct {
        logic req;
        logic req_is_wr;
    } idma_reg_NumDims_4_Log2NumDims_2__done_id__external__out_t;
    ...
    typedef struct {
        ...
        idma_reg_NumDims_4_Log2NumDims_2__status__external__out_t status[16];
        idma_reg_NumDims_4_Log2NumDims_2__next_id__external__out_t next_id[16];
        idma_reg_NumDims_4_Log2NumDims_2__done_id__external__out_t done_id[16];
...
localparam longint unsigned IDMA_REG_SIZE = 64'h104;
...
module idma_reg32_4d #(
  ...
  for (genvar i = 0; i < NumRegs; i++) begin : gen_core_regs
    ...
    always_comb begin : proc_hw_req_conv
      ...
      arb_dma_req[i].d_req[2].reps = dma_reg2hw[i].dim[2].reps[0].reps.value;
      arb_dma_req[i].d_req[2].src_strides = dma_reg2hw[i].dim[2].src_stride[0].src_stride.value;
      arb_dma_req[i].d_req[2].dst_strides = dma_reg2hw[i].dim[2].dst_stride[0].dst_stride.value;

      // Disable higher dimensions
      if ( dma_reg2hw[i].conf.enable_nd.value == 0) begin
        arb_dma_req[i].d_req[0].reps = '0;
        arb_dma_req[i].d_req[1].reps = '0;
        arb_dma_req[i].d_req[2].reps = 'd1;
      end
