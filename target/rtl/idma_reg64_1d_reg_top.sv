...
module idma_reg64_1d_reg_top #(
    ...
    always_comb begin
        ...
        load_next_c = '0;
        if(decoded_reg_strb.conf && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.conf.deadlock_free.value & ~decoded_wr_biten[18:18]) | (decoded_wr_data[18:18] & decoded_wr_biten[18:18]);
            load_next_c = '1;
        end
    ...
    always_comb begin
        ...
        if(rd_mux_addr == 9'h0) begin
            ...
            readback_data_var[18] = field_storage.conf.deadlock_free.value;
        end
        for(int i0=0; i0<16; i0++) begin
