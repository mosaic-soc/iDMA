...
module idma_transport_layer_r_axi_rw_init_rw_obi #(
    ...
    idma_axi_read #(
        ...
        .ar_valid_i        ( (ar_req_i.src_protocol == idma_pkg::AXI) & ar_gated_valid ),
    ...
    idma_init_read #(
        ...
        .read_meta_valid_i ( (ar_req_i.src_protocol == idma_pkg::INIT) & ar_gated_valid ),
    ...
    idma_obi_read #(
        ...
        .read_meta_req_i   ( ar_req_i.ar_req ),
        .read_meta_valid_i ( (ar_req_i.src_protocol == idma_pkg::OBI) & ar_gated_valid ),
    ...
    always_comb begin : gen_read_meta_channel_multiplexer
        ...
        idma_pkg::AXI: ar_gated_ready = axi_ar_ready;
        idma_pkg::INIT: ar_gated_ready = init_ar_ready;
        idma_pkg::OBI: ar_gated_ready = obi_ar_ready;
    ...
    if (EnableCompute) begin : gen_compute
        ...
        `ASSERT(ComputeConsumeValid, cmp_consumed_this_cycle != '0 |-> cmp_out_valid, clk_i, !rst_ni, "Write datapath consumed bytes without a valid compute result")
